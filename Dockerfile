...
WORKDIR /erickemissormicroservico
...
COPY --from=build /erickemissormicroservico/target/*.jar erickemissormicroservico.jar

# Exponha a porta que a aplicação vai usar
EXPOSE 8080

# Comando para rodar a aplicação
ENTRYPOINT ["java", "-jar", "erickemissormicroservico.jar"]